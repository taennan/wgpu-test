use crate::{
    ...
    scene::{
        ...
        mesh::{self, Mesh, buffer_data::MeshInstanceBufferData},
    },
    utils::paths,
};
use std::{mem, path::PathBuf, sync::LazyLock};
use wgpu::{
    BindGroup, BindingResource, BindingType, BufferUsages, CommandEncoder, Device, RenderPass,
