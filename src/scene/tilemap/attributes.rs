use glam::{I64Vec3, U16Vec2, UVec2, Vec3};
...
type Tile = u32;
type ChunkPosition = I64Vec3;
type ChunkedTilePosition = U16Vec2;
type GlobalTilePosition = I64Vec3;
...
impl TilemapAttributes {
    ...
    pub fn texture_tilecount(&self) -> &UVec2 {
        &self.texture_tilecount
    }
...
pub struct TilemapTileIteratorItem<'a> {
    pub chunk_position: &'a ChunkPosition,
    pub tile_chunk_position: &'a ChunkedTilePosition,
    pub tile_global_position: &'a GlobalTilePosition,
    pub tile: Tile,
}
...
impl<'a> Iterator for TilemapTileIterator<'a> {
    type Item = TilemapTileIteratorItem<'a>;
